...
class CasperSpider(scrapy.Spider):
    ...
    def parse(self, response):    
        ...
        for singlereview in reviews:
            ...
            #scrape info
            try:
                name    = singlereview.xpath('.//div[@class="review-name"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                age     = singlereview.xpath('.//div[@class="review-age"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                city    = singlereview.xpath('.//div[@class="review-info"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                state   = singlereview.xpath('.//div[@class="review-info"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                title   = singlereview.xpath('.//div[@class="review-title body--serif"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                review  = singlereview.xpath('.//p//text()').extract_first().strip()
            except:
                try:
            ...
            try:
                rating  = singlereview.xpath('.//meta/@ratingvalue').extract_first().strip()
            except:
                try:
            ...
            try:
                hours   = singlereview.xpath('.//div[@class="review-hours-number"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                partners= singlereview.xpath('.//div[@class="review-partner-label"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                date    = singlereview.xpath('.//div[@class="review-date"]/text()').extract_first().strip()
            except:
                try:
            ...
            try:
                verified= singlereview.xpath('.//div[@class="review-verified-wrapper js-review-verified-wrapper"]//text()').extract_first().strip()
            except:
                try:
